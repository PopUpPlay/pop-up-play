...
export default function ReelViewer({ reel, profile, isActive, onToggleMute, isMuted, reelIndex }) {
  ...
  return (
    <div className="relative w-full h-full bg-black">
      ...
      {/* Progress Bar */}
      <div className="absolute bottom-[72px] left-0 right-0 px-6 z-10 pointer-events-auto">
        <div
          ref={progressBarRef}
      ...
      <div className="absolute bottom-[30%] left-0 right-0 p-6 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
