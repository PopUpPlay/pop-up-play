...
export default function ChatConversation({ 
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto p-4 bg-slate-50 scrollbar-thin scrollbar-thumb-purple-400 scrollbar-track-slate-200 hover:scrollbar-thumb-purple-500">
